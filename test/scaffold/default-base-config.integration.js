...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    alveyd.spawn.datadir.should.equal(home + '/.alvey');
    alveyd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/alveyd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.alveyd.spawn.datadir.should.equal('./data2');
  });
});
