...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `alveycore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ alveycore-node add wallet-service');
      console.log('    $ alveycore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ alveycore-node remove wallet-service');
      console.log('    $ alveycore-node remove insight-api');
      console.log();
    });
