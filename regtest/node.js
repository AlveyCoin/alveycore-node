...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.alveyd.height === 150) {
            node.services.alveyd.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.alveyd.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('alveyd/hashblock', function(data) {
        bus.unsubscribe('alveyd/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.alveyd.height;
      node.services.alveyd.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.alveyd.sendTransaction(tx.serialize(), function(err, hash) {
